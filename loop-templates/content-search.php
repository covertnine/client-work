...
<div class="col-xs-12 col-sm-3 mb-5">
	<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
		...
		if ( has_post_thumbnail() ) {
			...
			$c9_img_src    = wp_get_attachment_image_url( $c9_img_id, 'medium' );
			$c9_img_srcset = wp_get_attachment_image_srcset( $c9_img_id, 'medium' );
			$c9_img_sizes  = wp_get_attachment_image_sizes( $c9_img_id, 'medium' );
